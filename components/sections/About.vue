<template>
  <section id="about" class="about-linear-gradient backdrop-blur flex flex-wrap items-center justify-center z-20">
    <NuxtImg data-aos="fade-right" class="h-auto sm:w-1/2 md:max-w-screen-md border-8 content-center object-cover shadow-2xl" src="/melanie/melanie.jpg" alt="Melanie"/>
