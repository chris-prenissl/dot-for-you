<template>
  <section id="about" class="about-linear-gradient backdrop-blur flex flex-wrap items-center justify-center gap-8">
    ...
    <div data-aos="fade-left" class="sm:w-40svh md:max-w-screen-lg p-4 md:p-16 rounded-l backdrop-blur-2xl">
      <h2 class="mb-4 md:mb-16 text-3xl font-bold">Melanie</h2>
      <p class="md:text-lg md:max-w-screen-lg text-text_on_primary p-2 rounded-l">Mein Name ist Melanie Zimmer und ich wohne zusammen mit meinem Mann und unseren
...
.about-linear-gradient {
  ...
  background: linear-gradient(to top, rgba(247, 211, 223, 0.8) 10%, rgba(249, 249, 249, 0.8) 100%), url("/public/melanie/melanie_bg.png") no-repeat center;
}
</style>