...
<template>
  <Swiper class="w-full sm:w-1/2 m-auto drop-shadow-lg"
          :modules="[SwiperAutoplay, SwiperNavigation, SwiperPagination, SwiperEffectCoverflow]"
          :effect="'coverflow'"
          :autoplay="true"
          :delay="200"
  ...
  >
    <SwiperSlide
        ...
        :key="index">
      <ArtImage class="w-full" :src-path="image.url" :title="image.title" img-sizes="40svw md:100svw"/>
    </SwiperSlide>
  </Swiper>
</template>
