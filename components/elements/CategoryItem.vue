...
import CategoryGallery from "~/components/elements/CategoryGallery.vue";
...
<template>
  <div class="min-h-svh p-2 sm:p-8 content-center">
    <h1 class="text-3xl text-center py-16">{{ category.title }}</h1>
