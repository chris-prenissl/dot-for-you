...
<template>
	<section
		...
		class="content-center bg-cover bg-center z-10"
	>
		<div
			id="hero-element"
			class="max-w-screen-md p-4 mt-32 md:m-auto md:p-10 rounded-sm"
		>
			<h1 class="text-2xl md:text-4xl font-bold text-light_white pb-4">
				Mit Liebe.<br>handgemacht.
			</h1>
