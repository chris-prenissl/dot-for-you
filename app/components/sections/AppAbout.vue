<template>
	<section
		id="about"
		class="about-linear-gradient backdrop-blur content-center z-6"
	>
		<div class="mx-auto pt-4 flex flex-wrap gap-2 justify-center items-stretch">
			...
			<div
				data-aos="fade-left"
				class="sm:w-2/5 md:max-w-screen-sm p-2 md:p-4 content-center bg-light_white bg-opacity-50 rounded-l backdrop-blur-2xl shadow-2xl border-2 border-primary"
			>
				<h2 class="p-2 text-3xl sm:text-xl font-bold">
					Über mich
				</h2>
